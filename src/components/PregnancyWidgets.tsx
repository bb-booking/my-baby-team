  ...
  return (
    <div className="card-soft flex items-center gap-5 section-fade-in">
      <div className="flex flex-col items-center flex-shrink-0 min-w-[64px]">
        ...
        <span className="label-upper mt-1">UGE</span>
      </div>
      <div className="flex-1">
        <p className="text-[0.95rem] mb-2">{trimester}. trimester</p>
        ...
        <div className="flex justify-between mt-1.5">
          <span className="text-[0.56rem] tracking-[0.1em] uppercase text-muted-foreground">1. trim</span>
          <span className="text-[0.56rem] tracking-[0.1em] uppercase text-muted-foreground">2. trim</span>
          <span className="text-[0.56rem] tracking-[0.1em] uppercase text-muted-foreground">3. trim</span>
        </div>
      </div>
    </div>
  );
    ...
    >
      ...
      <div>
        ...
        <p className="text-[0.78rem] text-muted-foreground mt-1 leading-relaxed">
          Baby vokser dag for dag — alt er som det skal være.
        </p>
      </div>
    </div>
  );
